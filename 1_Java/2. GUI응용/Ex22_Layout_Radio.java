...
public class Ex22_Layout_Radio extends JFrame{

	// 기본생성자
	public Ex22_Layout_Radio() {
		...
		con1.add(lOp1); con1.add(rBtn1); con1.add(rBtn2); con1.add(rBtn3); con1.add(rBtn4); con1.add(rBtn5); 
