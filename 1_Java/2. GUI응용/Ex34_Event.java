...
public class Ex34_Event extends JFrame {
	...
	public Ex34_Event() {
		...
		// 5. 이벤트 처리
		// 5-1. 계산(btn1) 버튼 클릭시 이벤트
		btn1.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {

				int su1 = Integer.parseInt(tNum1.getText()); // getText() : tNum1에 입력된 글자를 텍스트로 인식한다. 
				int su2 = Integer.parseInt(tNum2.getText()); // getText() : tNum2에 입력된 글자를 텍스트로 인식한다. 
				String operator = tOp1.getText(); 
				String result = "";
