...
<div class="cont">
	...
	<div class="form-main">
		<div class="desc">
		<form class="desx" action="<%=request.getContextPath()%>/addr_modify5_ok.do" method="post">
				...
				<br><br>
						<div class="input_addr">
							...
							<input type="text" id="sample6_postcode" name="member_addr5" placeholder="우편번호" readonly><br>
							<br>
							<div>
								<label class="input_label">도로명주소</label>
							</div>
							<input type="text" id="sample6_address" name="member_addr5" placeholder="주소" readonly><br>
							<br>
							<div>
								
							</div>
							<input type="text" id="sample6_extraAddress"  name="member_addr5" placeholder="참고항목" readonly><br>
							<br>
							<div>
								<label class="input_label">상세주소</label>
							</div>
							<input type="text" id="sample6_detailAddress"  name="member_addr5" placeholder="상세주소">
						</div>
				<br>
					<div class="last_btn">
							<div>
