	           ...
	           <section id="section-suggestion">
	               ...
	               <div class="sug_area">
	               		...
	               		<c:if test="${!empty bookList }">
	               			<c:forEach items="${bookList }" var="bookList" end="2">
	               				<div class="sug_div" style="background-image: url('<%=request.getContextPath() %>/book_cover/${bookList.getBook_img() }');">
			                       <a class="sug_a" href="<%=request.getContextPath() %>/book_detail.do?book_num=${bookList.getBook_num() }">
			                           <div class="sug_img_p">
			                               <img class="sub_img" src="<%=request.getContextPath() %>/book_cover/${bookList.getBook_img() }">
			                           </div>
	                      ...
	                      <div class="mypage-cont coupon_mileage_div">
	                          ...
	                          <div class="coupon_mileage_each">
	                              <a class="coupon_mileage_a">
	                                  ...
	                                  <div class="coupon_mileage_cnt">
	                                      <p>
	                                         <fmt:formatNumber value="${memberList.getMem_mileage() }"/> p
	                                      </p>
	                                  </div>
	                              </a>
	                          </div>
                                    	...
                                    	<c:forEach items="${orderList }" var="orderList" >
	                                    	...
	                                    	<tr class="mypage_table_tr">
		                                        ...
		                                        <td class="order_tbody_img">
		                                             <a href="<%=request.getContextPath() %>/book_detail.do?book_num=${orderList.getBook_num() }">
		                                                <img src="<%=request.getContextPath() %>/book_cover/${orderList.getBook_img() }">
		                                            </a>
		                                        </td>
		                                        
		                                         <!-- 책이름 -->
		                                        <c:if test="${orderList.getOrder_count()>1 }">
		                                        	<td class="order_tbody_bname">${orderList.getBook_name() } 외 ${orderList.getOrder_count()-1 }</td>
		                                        </c:if>
		                                         <c:if test="${orderList.getOrder_count()==1 }">
		                                        ...
		                                        <td class="order_tbody_price">
		                                        	<fmt:formatNumber value="${orderList.getTotal_order_price() }"/> 원
		                                        </td>
	                                      </tr>
                                        </c:forEach>
                                    </c:if>
