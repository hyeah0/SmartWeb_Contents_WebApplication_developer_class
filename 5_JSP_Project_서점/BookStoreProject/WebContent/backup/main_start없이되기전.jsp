...
<body>
       ...
       <div id="center">
            <section class="center_section center_banner_ad">
            	...
            	<div class="slider-container" >
                    ...
                    <c:forEach items="${bannerList }" var="banner">
                    	<a class="slide active" href="#" style="background-image: url('${banner.getBanner_img() }')">    
                    	</a>
                    </c:forEach>
            ...
            <section class="center_section center_banner_loca">
                <a class="center_banner_loca_a">
                	<%-- <img src="<%=request.getContextPath() %>/source/img/banner/locationBanner.jpeg" alt="locationStore"> --%>
                </a>
            </section>
