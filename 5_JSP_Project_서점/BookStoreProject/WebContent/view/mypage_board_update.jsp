...
<meta charset="UTF-8">
	...
	<script type="text/javascript" src="js/mypageJs/boardUpdateImg.js"></script>     
</head>
<body>
                            ...
                            <table class="mypage_table board-table">
                                <tbody class="board-table_tbody">
                                    ...
                                    <tr class="board-table_tr">
                                        <td>
                                        	<textarea class="board-table_inputCont" name="board_cont" id="" cols="50" rows="20">${boardDto.getBoard_cont() }</textarea>
                                        </td>
                                    </tr>
	                                        ...
	                                        <td class="board-table_beFile">
	                                        	<div class="board-table_beFile_div">
		                                            <div class="board-table_beFile_div_img">
		                                            	 <img alt="첨부사진" name="board_beimage" src="<%=request.getContextPath() %>/boardUpload/${boardDto.getBoard_image() }" width ="100px">
		                                            </div>
		                                            <div class="btn board-table_beFile_btn">
