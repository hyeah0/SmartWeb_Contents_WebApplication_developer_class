...
public class BookDTO {
   ...
   private String book_update;      // 수정일
   ...
   private String book_writer_cont;
   ...
   private int order_year;  //1년동안 주문건
    ...
    public String getBook_writer_cont() {
        return book_writer_cont;
    }
    public void setBook_writer_cont(String book_writer_cont) {
        this.book_writer_cont = book_writer_cont;
    }
