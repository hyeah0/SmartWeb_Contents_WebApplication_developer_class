	...
	<!-- center -->
        <div id="center">
            <div class="category_page">
            	<!-- nav -->
                <!-- <section class="center_section center_nav">
                    <nav>
                        <ul>
                            <li>도서전체보기</li>
                            <li>소설</li>
                    ...
                    <section class="center_section center_cont_search_pick">
                        ...
                        <div class="book_pick">
                           	...
                           	<c:if test="${search == 1 }">
                            	...
                            	<p>|</p>
                            	<button class="btn"  onclick="location.href='<%=request.getContextPath()%>/main_getBookCategory.do?${ururi_listTypei_list }&requestType=book_recent${uri_nowCgy }&${uri_page }&${uri_search }'">최신 등록순</button>
                        ...
                        <div class="book_search">
                            ...
                            <div class="book_search_layout">
                            	...
                            	<c:if test="${search != 1 }">
                               	...
                               	<!-- 검색한 상태 -->
                                <c:if test="${search == 1 }">
                               		<button class="btn layout_size_btn" onclick="location.href='<%=request.getContextPath() %>/main_getBookCategory.do?listType=2&${uri_requestType }&${uri_nowCgy_num }&${uri_page }&${uri_search }'">
                                </c:if>
                                <!-- 검색하지 않은 상태 -->
                            	<c:if test="${search != 1 }">
                            		<button class="btn layout_size_btn" onclick="location.href='<%=request.getContextPath() %>/main_getBookCategory.do?listType=2&${uri_requestType }&${uri_nowCgy_num }&${uri_page }'">
                            	</c:if>
                            	...
                            	<div class="center_books_div">
                            		...
                            		<c:forEach items="${bookCgyList }" var="bookList" begin="0" step="1"> 
		                                <div class="booklist category_booklist"> 
		                                    ...
		                                    <form class="cart_num_form" method="post" action="">
		                                        <input type="number" class="input cart_num_input" name="cart_num" placeholder="1" max="100" min="1">
                            ...
                            <div class="center_books_list">
                            		...
                            		<c:forEach items="${bookCgyList }" var="bookList"> 
		                                ...
		                                <div class="center_book_list_type">
		                                    ...
		                                    <form class="list_type_button" method="post" action="">
		                                        <input type="number" class="input cart_num_input" name="cart_num" placeholder="1" max="100" min="1">
		                                        <div class="booklist_btn">
		                                            <button class="btn" type="submit"><i class="fa-brands fa-shopify"></i></button>
		                                            <button class="btn" type="submit"><i class="fa-solid fa-basket-shopping"></i></button>
