...
<head>
<meta charset="UTF-8">
<title>EL(표현 언어) 내장객체 출력1</title>
</head>
<body>
	<h2>Ex05에서 forward로 이동된 페이지 (현재 파일명 : Ex06)</h2>
	<p>forward로 이동된 페이지는 파일명이 url에서 확인 되지 않는다.</p>
	<p>http://localhost:8181/11_EL_JSTL/EL/Ex05.jsp </p>
	<br>
